export const OnlineShopPoster = () => {
    return (
        <div
            className="relative w-full aspect-[16/9] md:aspect-[32/4] flex overflow-hidden justify-between"
            style={{
        ...
        >
            ...
            <img
                src="/assets/onlineshop/poster.png"
                alt="Poster"
