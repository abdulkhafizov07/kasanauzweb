export default function SuccessfulExperience() {
  return (
    <div className="successful-experience my-8 bg-brand overflow-hidden">
      <div className="container mx-auto max-w-[1366px] flex items-center gap-x-8 p-4">
        <div className="side w-1/2 max-h-min">
