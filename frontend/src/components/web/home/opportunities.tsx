...
const OpportunitiesSection: React.FC = () => {
  ...
  return (
    <section id="opportunities" className="overflow-hidden">
      <div className="container mx-auto max-w-[1366px] py-6 px-4">
        <div className="flex items-start justify-center flex-col md:flex-row gap-12">
          ...
          /assets/home/home11_720.webp 720w"
              ...
              <div className="w-2/5">
                <div
                  className="relative card aspect-[6/6] bg-bg-placeholder rounded-lg overflow-hidden border border-border"
                  data-aos="fade-left"
                >
                  <img
