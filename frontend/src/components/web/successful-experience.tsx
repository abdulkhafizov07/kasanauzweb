...
export const SuccessfulExperienceWidget: React.FC = () => {
    ...
    return (
        <div className="hidden md:block successful-experience my-8 bg-brand overflow-hidden">
            <div className="container mx-auto max-w-[1366px] flex flex-col md:flex-row md:items-center gap-0 md:gap-x-8 p-4">
                <div className="side w-1/2 max-h-min" ref={leftSideRef}>
                ...
                >
                    <div className="content flex h-full justify-between">
                        ...
                        <div className="relative graphics w-full h-full flex items-center justify-center">
                            <img
                                src="/assets/courses/mubina-ismatova.png"
