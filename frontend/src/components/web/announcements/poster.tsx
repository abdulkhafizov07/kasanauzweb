...
export const AnnouncementsPoster: React.FC = () => {
    return (
        <>
            <div className="aspect-[32/10] md:aspect-[32/5] w-full flex justify-between relative overflow-hidden">
                ...
                <div className="absolute z-20 top-0 right-0 aspect-[32/10] md:aspect-[32/5] w-full">
                    <img
                        src="/assets/announcements/poster_720.webp"
                        srcSet="
    /assets/announcements/poster_480.webp 480w,
    /assets/announcements/poster_720.webp 720w
  "
