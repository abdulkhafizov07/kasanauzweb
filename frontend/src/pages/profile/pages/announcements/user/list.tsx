...
const ListPage: React.FC = () => {
  ...
  const { userAnnouncements, loadUserAnnouncements } = useAnnouncements();
  ...
  return (
    <>
      <div className="page-title flex w-full items-center justify-between mb-6">
        <h2 className="title text-4xl font-bold">{t("My announcements")}</h2>
      </div>
      ...
      <div className="content list-products overflow-x-auto">
        ...
        {userAnnouncements.length === 0 ? (
          ...
          <DatatableWidget
            ...
            data={userAnnouncements.map((value) => ({
              select: (
                <CheckboxWidget
