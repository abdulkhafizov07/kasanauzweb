...
export const EditPage: React.FC = () => {
  ...
  const fetchData = async () => {
    ...
    try {
      const res = await axios.get(`${coursesApi}dashboard/course/${guid}/`);
  ...
  const onSubmit = async (values: FormValues) => {
    try {
      await axios.put(`${coursesApi}dashboard/course/${guid}/`, values);
  ...
  useEffect(() => {
    document.title = "Kurs tahrirlash - Admin - Kasana.UZ";
  }, []);
