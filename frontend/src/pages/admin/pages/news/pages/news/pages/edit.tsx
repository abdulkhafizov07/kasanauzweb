...
export const EditPage: React.FC = () => {
  ...
  const fetchData = async () => {
    ...
    try {
      const res = await axios.get(`${newsApi}dashboard/news/${guid}/`);
  ...
  const onSubmit = async (values: FormValues) => {
    try {
      await axios.put(`${newsApi}dashboard/news/${guid}/`, values);
  ...
  return (
    <div id="edit-product-page" className="px-3">
      <div className="page-title mb-3">
        <h3 className="text-2xl font-semibold">{t("admin.pages.edit_news")}</h3>
      </div>
        ...
        {loading ? (
          ...
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 align-start justify-start">
                <FormField
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>{t("news.meta")}</FormLabel>
                      <FormControl>
                        <Input {...field} />
                      </FormControl>
                      <FormMessage />
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem className="col-span-2">
                      <FormLabel>{t("news.short_description")}</FormLabel>
                      <FormControl>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem className="col-span-2">
                      <FormLabel>{t("news.description")}</FormLabel>
                      <FormControl>
                        <Editor {...field} />
                      </FormControl>
                      <FormMessage />
